...
import pacman.controllers.MaximizeLevelPacmanController;
import pacman.controllers.MaximizePointsPacmanController;
...
{	
	...
	public static void main(String[] args)
	{
		...
		System.out.println("STARTER " + MaximizePointsPacmanController.class + " vs " + Legacy2TheReckoning.class);
		exec.runGame(new MaximizePointsPacmanController(), new Legacy2TheReckoning(), visual, delay);
		
		System.out.println("STARTER " + MaximizeLevelPacmanController.class + " vs " + Legacy2TheReckoning.class);
		exec.runGame(new MaximizeLevelPacmanController(), new Legacy2TheReckoning(), visual, delay);

		System.out.println("STARTER " + MaximizePointsPacmanController.class + " vs " + AggressiveGhosts.class);
		exec.runGame(new MaximizePointsPacmanController(), new AggressiveGhosts(), visual, delay);
		
		System.out.println("STARTER " + MaximizeLevelPacmanController.class + " vs " + AggressiveGhosts.class);
		exec.runGame(new MaximizeLevelPacmanController(), new AggressiveGhosts(), visual, delay);

		System.out.println("STARTER " + MaximizePointsPacmanController.class + " vs " + Legacy.class);
		exec.runGame(new MaximizePointsPacmanController(), new Legacy(), visual, delay);
		
		System.out.println("STARTER " + MaximizeLevelPacmanController.class + " vs " + Legacy.class);
		exec.runGame(new MaximizeLevelPacmanController(), new Legacy(), visual, delay);

		System.out.println("STARTER " + MaximizePointsPacmanController.class + " vs " + RandomGhosts.class);
		exec.runGame(new MaximizePointsPacmanController(), new RandomGhosts(), visual, delay);
		
		System.out.println("STARTER " + MaximizeLevelPacmanController.class + " vs " + RandomGhosts.class);
		exec.runGame(new MaximizeLevelPacmanController(), new RandomGhosts(), visual, delay);
		
		System.out.println("STARTER " + MaximizePointsPacmanController.class + " vs " + StarterGhosts.class);
		exec.runGame(new MaximizePointsPacmanController(), new StarterGhosts(), visual, delay);
		
		System.out.println("STARTER " + MaximizeLevelPacmanController.class + " vs " + StarterGhosts.class);
		exec.runGame(new MaximizeLevelPacmanController(), new StarterGhosts(), visual, delay);
	}
